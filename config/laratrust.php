...
return [
    ...
    */
    'foreign_keys' => [
        ...
        /**
         * RoleController foreign key on Laratrust's role_user and permission_role tables.
         */
        'role' => 'role_id',

        /**
         * RoleController foreign key on Laratrust's permission_user and permission_role tables.
         */
        'permission' => 'permission_id',

        /**
         * RoleController foreign key on Laratrust's role_user and permission_user tables.
         */
        'team' => 'team_id',
    ],
